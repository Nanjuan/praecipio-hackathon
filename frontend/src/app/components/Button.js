...
const ButtonMain = () => {
    return (
        <button className="w-full h-40 flex items-center justify-center cursor-pointer">
            ...
            >
                <span
                    className="absolute bottom-0 left-0 w-full h-1 transition-all duration-150 ease-in-out bg-tertiaryColor group-hover:h-full"
                ></span>
                <span
                ...
                >
                    <svg
                        ...
                        stroke="currentColor"
                        fill="none"
                        className="w-5 h-5 text-assentColor"
                    >
                        <path
